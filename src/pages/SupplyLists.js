        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-ps146-navy-700 text-sm">
                <li><a href="/school-events" className="hover:text-ps146-coral-600 transition-colors">School Events</a></li>
                <li><a href="http://www.smoothusa.com/ps146m" target="_blank" rel="noopener noreferrer" className="hover:text-ps146-coral-600 transition-colors">School Store</a></li>
