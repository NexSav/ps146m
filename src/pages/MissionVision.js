    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="py-24 bg-ps146-navy-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-light mb-6">Our Educational Approach</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="group bg-white/10 backdrop-blur-sm p-8 rounded-2xl hover:bg-white/15 transition-all duration-300 border border-white/10 hover:border-ps146-coral-400/50 hover:shadow-2xl transform hover:-translate-y-2">
                <div className="w-16 h-16 bg-ps146-coral-600/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-ps146-coral-600/30 transition-colors">
                  <item.icon className="h-8 w-8 text-ps146-coral-400" />
                </div>
                <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-ps146-coral-300 transition-colors">{item.title}</h3>
