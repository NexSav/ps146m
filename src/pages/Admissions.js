      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* School Information */}
            <div className="bg-gradient-to-br from-ps146-gold-50 to-ps146-coral-50 p-10 rounded-3xl relative overflow-hidden shadow-lg border-2 border-ps146-gold-100">
              <div className="absolute top-8 right-8 w-32 h-32 bg-ps146-coral-200/30 rounded-full blur-2xl"></div>
              <div className="absolute bottom-8 left-8 w-20 h-20 bg-ps146-gold-200/30 rounded-full blur-2xl"></div>

              <div className="relative z-10">
                <h3 className="text-3xl font-light mb-8 text-ps146-navy-900">Why Choose PS 146?</h3>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={index} className="flex items-start group">
                      <div className="w-3 h-3 bg-ps146-coral-500 rounded-full mt-2.5 mr-4 flex-shrink-0 group-hover:scale-150 transition-transform shadow-sm"></div>
                      <div>
                        <h4 className="font-bold text-lg mb-2 text-ps146-navy-900">{benefit.title}</h4>
                        <p className="text-ps146-navy-700 leading-relaxed">{benefit.description}</p>
                      </div>
                    </div>
                  ))}
                </div>

                <div className="mt-10 p-6 bg-white rounded-2xl shadow-md border-2 border-ps146-coral-200">
                  <p className="text-center text-ps146-navy-900 font-medium text-lg">
      ...
      <footer className="bg-gradient-to-br from-ps146-coral-50 to-ps146-coral-100 py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <h4 className="font-bold mb-4 text-ps146-navy-900 text-lg">Admissions</h4>
              <ul className="space-y-3 text-ps146-navy-700 text-sm">
