        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="relative transform group-hover:scale-105 transition-all duration-300">
              <div className="w-10 h-10 bg-ps146-coral-600 rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                <span className="text-white font-bold text-base group-hover:scale-110 transition-transform duration-300">146</span>
              </div>
            </div>
            <div className="hidden sm:block">
              <div className="text-lg font-bold text-white tracking-tight">PS 146</div>
              <div className="text-xs font-medium text-ps146-coral-400 -mt-0.5">Anna M. Short</div>
            </div>
          </Link>
              ...
              <div key={index} className="relative group">
                {item.dropdown ? (
                  <div>
                    <Link
                      to={item.href}
                      className="flex items-center px-4 py-2 text-sm font-medium text-white/90 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-300"
          ...
          <div className="lg:hidden">
            <button
              ...
              className="inline-flex items-center p-2 w-10 h-10 justify-center text-white rounded-lg hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-ps146-coral-400 transition-colors duration-200"
            >
